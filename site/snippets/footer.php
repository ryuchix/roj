            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-col">
                        ...
                        <p class="footer-words">At Serviceswe are obsessed about gadgets and gizmos. We’re the folks standing in line on launch day waiting for the lates.</p>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-col service-col">
                        ...
                        <ul class="footer-list">
                            ...
                            <li><a href="#">Electronics Repair</a></li>
                            <li><a href="#">Smartphone Repair</a></li>
                            <li><a href="#">Console Repair</a></li>
                            <li><a href="#">Electronics Recovery</a></li>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-col post-column">
                        ...
                        <div class="post-list">
                            <div class="post">
                                <div class="post-thumb"><a href="#"><img src="images/blog/i1.jpg" alt=""></a></div>
                                <a href="#"><h5>Why Your Computer Hates You.</h5></a>
                                <div class="post-info"><i class="fa fa-calendar"></i>  20 jun, 2017</div>
                            </div>
                            <div class="post">
                                <div class="post-thumb"><a href="#"><img src="images/blog/i2.jpg" alt=""></a></div>
                                <a href="#"><h5>Easy Tips To Mobile Repair on chip.</h5></a>
...
<!-- bx slider /-->
<script src="<?php echo url() ?>/assets/js/jquery.bxslider.min.js"></script>
<!-- count to /-->
...
<script src="<?php echo url() ?>/assets/js/map-helper.js"></script>
<!-- fancy box /-->
<script src="<?php echo url() ?>/assets/js/jquery.fancybox.pack.js"></script>
<script src="<?php echo url() ?>/assets/js/jquery.appear.js"></script>


<!-- jQuery ui js /-->
<script src="<?php echo url() ?>/assets/js/jquery-ui.js"></script>
<script src="<?php echo url() ?>/assets/js/SmoothScroll.js"></script>
<script src="<?php echo url() ?>/assets/js/validation.js"></script>
